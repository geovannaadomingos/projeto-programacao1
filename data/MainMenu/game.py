...
class Game():
    def __init__(self):
        ...
        self.DISPLAY_W, self.DISPLAY_H = 500, 800  # TAMANHO DA DELA
        self.display = pygame.Surface((self.DISPLAY_W,self.DISPLAY_H)) # CRIA A TELA COM AQUELAS DIMESSÕES
        self.window = pygame.display.set_mode(((self.DISPLAY_W,self.DISPLAY_H)))
        self.font_name = pygame.font.get_default_font() # FONTE PADRAO MAS DPS MUDAR PRA DO JOGO
        self.BLACK, self.WHITE = (0, 0, 0), (255, 255, 255) # CORES
